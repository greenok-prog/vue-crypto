  ...
  <div class="container mx-auto flex flex-col items-center bg-gray-100 p-4">
    ...
    <div class="container">
          ...
          <div class="max-w-xs">
            ...
            <div class="mt-1 relative rounded-md shadow-md">
              <input
                :input="helper"
                v-model="ticker"
                v-on:keydown.enter="add(this.ticker)"
                type="text"
                name="wallet"
                id="wallet"
            ...
            <!-- Error message -->
            <div v-if="er" class="text-sm text-red-600">
      ...
      <section v-if="selectedTicker" class="relative">
        ...
        <button @click="select(t)" type="button" class="absolute top-0 right-0">
          <svg
            xmlns="http://www.w3.org/2000/svg"
...
export default {
  ...
  watch: {
    ...
    paginetedTickers() {
      if ((this.paginetedTickers.length === 0) & (this.page > 1)) {
        this.page -= 1;
      }
    },
    filter() {
